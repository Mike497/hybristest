...
/**
 * This is the extension manager of the trainingcockpit extension.
 */
public class TrainingcockpitManager extends GeneratedTrainingcockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(TrainingcockpitManager.class.getName());
	 ...
	 */
	public static final TrainingcockpitManager getInstance()
	{
		return (TrainingcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingcockpitConstants.EXTENSIONNAME);
	}

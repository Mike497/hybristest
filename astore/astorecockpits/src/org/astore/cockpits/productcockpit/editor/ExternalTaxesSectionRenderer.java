 ...
 *  
 */
package org.astore.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("astorecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("astorecockpits.product.externalTaxes"));

 ...
 *  
 */
package org.astore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AstoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AstoreFulfilmentProcessConstants.PARENT_PROCESS);

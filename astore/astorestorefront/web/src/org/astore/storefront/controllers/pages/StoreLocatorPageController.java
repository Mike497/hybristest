...
import org.astore.storefront.controllers.ControllerConstants;
import de.hybris.platform.acceleratorstorefrontcommons.controllers.util.GlobalMessages;
import org.astore.storefront.util.MetaSanitizerUtil;
...
public class StoreLocatorPageController extends AbstractSearchPageController
{
			...
			CMSItemNotFoundException
	{
		...
		if (latitude != null && longitude != null)
		{
			...
			setUpSearchResultsForPosition(geoPoint, createPageableData(page, getStoreLocatorPageSize(), sortCode, showMode),
					model);
		}

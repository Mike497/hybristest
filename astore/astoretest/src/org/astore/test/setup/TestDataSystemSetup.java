...
import org.astore.test.constants.AstoreTestConstants;
import org.astore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/astoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/astoretest/import/reviews.impex");
			...
			importImpexFile(context, "/astoretest/import/cstickets.impex");
		}
	}
}
